...
## 📖 Overview
The **BookMyShow Platform** provides two distinct portals: 
...
2. **Compile the code**:
   ```bash
   javac BookMyShowSystem.java
   ```
3. **Run the application**:
   ```bash
   java BookMyShowSystem
   ```
...
BookMyShow/
├── src/
│   └── BookMyShowSystem.java      # Main source code file
